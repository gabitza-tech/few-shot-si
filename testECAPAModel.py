...
if __name__ == "__main__":
    ...
    parser.add_argument('--eval_list',  type=str,   default="/home/gpirlogeanu/git_repos/ECAPA-TDNN/dataset_files/voxceleb2_train_list.txt", help='The path of the evaluation list.')
    ...
    model.extract_embeddings(test_dataloader)
